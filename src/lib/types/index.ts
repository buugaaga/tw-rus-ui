...
export type NonNullableType = NonNullable<unknown>
...
type ClassNameOverride<TTag extends ReactTag, TSlot = NonNullableType> =
...
export type Props<
  ...
  TSlot = NonNullableType,
  TOmitableProps extends PropertyKey = never,
  Overrides = NonNullableType,
